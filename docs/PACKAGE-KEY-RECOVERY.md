...
## Encrypted Backup Separation

1. **Hardware Media**: Primary secret keys are backed up onto two LUKS-encrypted USB hardware tokens (Token Alpha and Token Beta).
...
5. Document all recovery steps in the private operations audit log.
