...
# Find ISO seed creation tool (FAIL CLOSED - NO synthetic Python or tar fallbacks!)
ISO_TOOL=""
if command -v cloud-localds >/dev/null 2>&1; then
    ...
    fail "No valid ISO generator found (cloud-localds, xorriso, genisoimage, or mkisofs required). Synthetic fallbacks are prohibited!"
fi
