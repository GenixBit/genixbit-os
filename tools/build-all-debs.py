...
def main() -> None:
    ...
    # Never mix stale package binaries with the current package build. The directory
    # is generated output and is already excluded from source control.
    for stale_deb in out_dir.glob("*.deb"):
        stale_deb.unlink()
